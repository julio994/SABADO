"""
Django settings for SABADO project.
...
SECRET_KEY = 'django-insecure-!=hw6ou-ifdhq^_i0-upp*66zeh5jgj9y=fuuj-vtr+nd5mk-4'
...
WSGI_APPLICATION = 'SABADO.wsgi.application'
